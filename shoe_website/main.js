...
(function () {
  ...
  const PRODUCTS = [
    ...
    { id: "p10", name: "Monarch Formal", type: "Formal", price: 199, rating: 4.9, reviews: "540", desc: "Handcrafted profile with rich detailing.", image: "https://www.theroyalepeacock.com/cdn/shop/products/cheaney-hanover-balmoral-boot-in-black-calf-leather-p1098-7599_image.jpg?v=1585727980&width=940", badge: "Luxury" },
...
placeOrderBtn?.addEventListener("click", () => {
  ...
  const phoneNumber = "919217571488";
...
//     // IMPORTANT: open in same tab fallback
...
//     },
//     (err) => {
//       alert("Location denied. Please allow location and try again.");
//       console.log(err);
//     },
//     {
